...
def patient_dataset_splitter_original(df, patient_key='patient_nbr'):
    '''
...
def create_tf_categorical_feature_cols(categorical_col_list,
    ...
    for c in categorical_col_list:
        ...
        '''
        dx_vocab = tf.feature_column.categorical_column_with_vocabulary_file(key=c,
                                                                             vocabulary_file =vocab_file_path, 
                                                                             num_oov_buckets=1)
        tf_categorical_feature_column = tf.feature_column.indicator_column(dx_vocab)
...
def create_tf_numeric_feature(col, MEAN, STD, default_value=0):
    ...
    tf_numeric_feature = tf.feature_column.numeric_column(key= col, 
                         ...
                         default_value=0, dtype=tf.float64)
